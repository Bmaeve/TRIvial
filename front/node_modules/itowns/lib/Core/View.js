...
var View = /*#__PURE__*/function (_THREE$EventDispatche) {
  ...
  function View(crs, viewerDiv) {
    ...
    if (!options.scene3D) {
      _this.scene.matrixWorldAutoUpdate = false;
    }
  ...
  (0, _createClass2["default"])(View, [{
    ...
    value: function resize(width, height) {
      if (width < 0 || height < 0) {
        console.warn("Trying to resize the View with negative height (".concat(height, ") or width (").concat(width, "). Skipping resize."));
        return;
      }
