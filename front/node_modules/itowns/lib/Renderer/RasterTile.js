...
var RasterTile = /*#__PURE__*/function (_THREE$EventDispatche) {
  ...
  function RasterTile(material, layer) {
    ...
    layer.addEventListener('opacity-property-changed', _this._handlerCBEvent);
    return _this;
  }
  ...
  (0, _createClass2["default"])(RasterTile, [{
    ...
    value: function dispose(removeEvent) {
      if (removeEvent) {
        ...
        this.layer.removeEventListener('opacity-property-changed', this._handlerCBEvent); // dispose all events
