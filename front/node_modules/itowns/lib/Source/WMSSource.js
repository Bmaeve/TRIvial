...
var WMSSource = /*#__PURE__*/function (_Source) {
  ...
  function WMSSource(source) {
    ...
    var crsPropName = _this.version === '1.3.0' ? 'CRS' : 'SRS'; // Add ? at the end of the url if it is not already in the given URL

    if (!_this.url.endsWith('?')) {
      _this.url = "".concat(_this.url, "?");
    }

    _this.url = "".concat(_this.url, "SERVICE=WMS&REQUEST=GetMap&LAYERS=").concat(_this.name, "&VERSION=").concat(_this.version, "&STYLES=").concat(_this.style, "&FORMAT=").concat(_this.format, "&TRANSPARENT=").concat(_this.transparent, "&BBOX=%bbox&").concat(crsPropName, "=").concat(_this.crs, "&WIDTH=").concat(_this.width, "&HEIGHT=").concat(_this.height);
